...
export const calendarEvents = [
  {
    title: "Math",
    allDay: false,
    start: new Date(2026, 4, 9, 11, 0),
    end: new Date(2026, 4, 9, 11, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2026, 4, 9, 12, 0),
    end: new Date(2026, 4, 9, 12, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 4, 9, 13, 0),
    end: new Date(2026, 4, 9, 13, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 4, 9, 14, 0),
    end: new Date(2026, 4, 9, 14, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2026, 4, 9, 15, 0),
    end: new Date(2026, 4, 9, 15, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 4, 9, 16, 0),
    end: new Date(2026, 4, 9, 16, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2026, 4, 9, 17, 0),
    end: new Date(2026, 4, 9, 17, 45),
  },
  {
    title: "Biology",
    allDay: false,
