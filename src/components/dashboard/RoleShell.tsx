...
export default function RoleShell({ title, subtitle, children, badge }: RoleShellProps) {
  return (
    <div className="space-y-5">
      <div className="rounded-[32px] bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 p-6 text-white shadow-[0_25px_60px_-25px_rgba(7,26,73,0.45)] sm:p-8">
