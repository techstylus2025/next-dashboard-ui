      ...
      <div className="w-full xl:w-2/3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            ...
            {/* CARD */}
            <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%] shadow-sm border border-slate-200">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-violet-500 to-fuchsia-500 text-white shadow-lg">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-7 h-7" aria-hidden="true">
                    <path d="M4.5 1a.5.5 0 0 0 0 1H11a.5.5 0 0 0 0-1H4.5z" />
                    <path d="M2 3a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v10a1 1 0 0 1-1 1H3a2 2 0 0 1-1-1V3z" />
                  </svg>
                </div>
              <div className="">
                <h1 className="text-xl font-semibold">
